...
func (p *IdRequest) SetVideoId(val int64) {
	p.VideoId = val
}
func (p *IdRequest) SetSearchId(val int64) {
	p.SearchId = val
}
...
func (p *IdRequest) Field2DeepEqual(src int64) bool {
...
type FeedServiceGetVideoByIdArgs struct {
	Req *IdRequest `thrift:"req,2" frugal:"2,default,IdRequest" json:"req"`
}
...
func (p *FeedServiceGetVideoByIdArgs) SetReq(val *IdRequest) {
	p.Req = val
}
...
func (p *FeedServiceGetVideoByIdArgs) Field2DeepEqual(src *IdRequest) bool {
