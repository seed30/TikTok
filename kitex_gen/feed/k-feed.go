...
func (p *IdRequest) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *IdRequest) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *IdRequest) field2Length() int {
	l := 0
...
func (p *FeedServiceGetVideoByIdArgs) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *FeedServiceGetVideoByIdArgs) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *FeedServiceGetVideoByIdArgs) field2Length() int {
	l := 0
