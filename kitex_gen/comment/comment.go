...
type Comment struct {
	...
	CreateDate int64  `thrift:"create_date,4" frugal:"4,default,i64" json:"create_date"`
}
...
func (p *Comment) writeField4(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("create_date", thrift.I64, 4); err != nil {
		goto WriteFieldBeginError
	}
...
type CommentListResponse struct {
	StatusCode  int32    `thrift:"status_code,1" frugal:"1,default,i32" json:"status_code"`
	StatusMsg   string   `thrift:"status_msg,2" frugal:"2,default,string" json:"status_msg"`
	CommentList *Comment `thrift:"comment_list,3" frugal:"3,default,Comment" json:"comment_list"`
}
...
func (p *CommentListResponse) writeField3(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("comment_list", thrift.STRUCT, 3); err != nil {
		goto WriteFieldBeginError
	}
